    ...
    <AnimatePresence>
      <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
        <motion.div 
          ...
          dir="rtl"
        >
          <div className="p-4 sm:p-6 border-b-4 border-black dark:border-white bg-[#FFEEA7] dark:bg-[#ca8a04] shrink-0 sticky top-0 z-10 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-xl sm:text-2xl font-black text-black dark:text-white">تواصل معنا</h2>
            </div>
            <button 
              onClick={onClose}
